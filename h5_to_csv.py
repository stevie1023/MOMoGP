...
def data_read_from_file(file_name=None, data_flag=None):
    ...
    if file_name is None:
        ...
        hf = h5py.File("/home/mzhu/madesi/data/IceDetection_ieckai10.h5", "r")
...
def load_data(file_name, data_flag, channel, is_plot=False):
    ...
    # features = [8,9,10,11,12,13,14,15,20,21,22,23,24,25]
    features = [0,1,2,3,4,5,8,9,10,11,14,15,16,17,20,21,22,23,12,13,18,19,24,25]
    ts_raw = ts_raw[3000:13001, features]
...
if __name__ == '__main__':
    ...
    # ts_raw = load_data(None, '_1.0-2.0-4.0', 8, True)
    data1 = pd.DataFrame(ts_raw)
    data1.to_csv('windmill24.csv',header = False, index = False)
